    ...
    <main className="bg-valuesBg">
            ...
            <span className="flex flex-col justify-start gap-4 w-full mt-8">
              ...
              <span className="flex flex-col gap-6">
                ...
                <span className="flex gap-4 items-center">
                  ...
                  <p>9674 N. Newcastle Ave. Wasilla, AK 99654</p>
                </span>
              </span>
            </span>
          </div>
      ...
      <>
        <div className={`contactus flex flex-col w-full`}>
          <div className="bg-lightBlue grid place-items-center py-20">
            <div className="w-9/12 flex flex-col bg-black py-10">
              {submited ? (
