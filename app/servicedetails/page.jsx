...
const ServiceDetails = () => {
  ...
  return (
    <main ref={containerRef} className="h-screen">
      ...
      <div className="values w-full flex justify-center pt-32 pb-16">
        <div className="w-10/12 md:w-9/12 flex flex-col font-Anton gap-6">
          <h1 className="text-5xl 2xl:text7xl">
            Do you want to know more about
          </h1>
          <span className="flex text-7xl 2xl:text-9xl">
            <h1>Our &nbsp;</h1>
                      ...
                      <span className="w-9/12 flex flex-col gap-4">
                        <span className="flex flex-col">
                          ...
                          <h1 className="font-extrabold text-white text-xl md:text-3xl pt-4">
                            Transform Your Social Presence with Our Services!
                          </h1>
                        </span>
                        <p className="font-light text-xs md:text-base text-white">
                          Ready to elevate your digital footprint? Let&apos;s
                          intertwine innovation, creativity, and strategy to
                          amplify your social media presence. Our dedicated team
                          is poised to turn your digital aspirations into
                          tangible results. Are you prepared to make a splash in
                          the social sphere? Reach out to us today, and let the
                          social magic commence!
                        </p>
                      </span>
                    </div>
