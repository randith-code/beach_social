                  ...
                  {submited ? (
                    ...
                    <div className="flex flex-col gap-8 items-center flex-1">
                      ...
                      <div className="flex 2xl:flex-col  items-center">
                        <div className="w-full md:pb-8 h-full grid place-items-center">
                          <span className="w-9/12 flex flex-col gap-4">
                            <span className="flex flex-col">
                              ...
                              <h1 className="font-extrabold text-white text-xl md:text-xl 2xl:text-3xl pt-4">
                        ...
                        <div className="w-full h-full grid place-items-center 2xl:pt-16">
                          <form
                            className="flex flex-col w-9/12 text-sm gap-4 2xl:gap-8 py-4 md:py-0"
                            action=""
