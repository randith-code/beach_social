export const FirstFeatureCard = ({ content }) => {
  return (
    <div className="relative w-full md:w-2/12 lg:w-3/12 aspect-square">
...
export const SecondFeaturesCard = ({ content }) => {
  return (
    <div className="flex flex-col items-center gap-4 justify-center bg-white drop-shadow w-full md:w-2/12 lg:w-3/12 aspect-square rounded-xl border-b-main border-b-4">
...
export const ThirdFeatureCard = ({ content }) => {
  return (
    <div className="flex flex-col items-center justify-center gap-4 bg-white drop-shadow w-full md:w-2/12 lg:w-3/12 aspect-square rounded-xl border-t-main border-t-4">
